...
### Note to add to the requirements.txt
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:password@localhost/fitness_db'
...
### Flask-login needs to load user
### @loginrequired can be used for things that require login
